...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0004_user_groups_user_is_superadmin_user_user_permissions_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_photos', models.ImageField(blank=True, null=True, upload_to='users/cover_photos')),
